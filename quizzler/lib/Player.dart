...
class Player {
  ...
  static List<bool> response = [null, null, null, null, null, null,null, null, null,null, null, null, null, null];

  static setResponse(int no, bool ans) {
    response[no] = qList[no].answer == ans;
  }
